          ...
          child: Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment
                  .start, //កំណត់​ Text Delicious food អោយមកខាងដើមscreen.
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment
                      .spaceBetween, //កំណត់border ពីtext welcome និង Icon
                  children: [
                    Text(
                      "welcome,",
                ...
                Container(
                    margin: EdgeInsets.only(right: 30.0), child: showItem()),
                SizedBox(
                  height: 20,
                ),
      ...
      children: [
        GestureDetector(
          ...
          child: Material(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: icecream ? Colors.red : Colors.black,
                  borderRadius: BorderRadius.circular(10)),
              padding: EdgeInsets.all(10),
              child: Image.asset(
                "images/icecream_icon.png",
                height: 40,
                width: 40,
              ),
            ),
