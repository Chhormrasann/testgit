          ...
          children: [
            ...
            Row(
              children:[ 
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Italian dish", style: AppWidget.semiBoolTextFeildStyle(),),
                    Text("Pizza", style: AppWidget.boldTextFeildStyle(),)
                  ],
                ),
                Spacer(),
                GestureDetector(
            ...
            Row(
              children: [
                ...
                SizedBox(width: 5.0,),
                Text("45min", style: AppWidget.semiBoolTextFeildStyle(),),
              ],
            ),
            Spacer(),
            Padding(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("Add to cart", style: TextStyle(color: Colors.white, fontFamily: 'PTSerif-BoldItalic'),),
                        SizedBox(width: 20,),
                        Container(
