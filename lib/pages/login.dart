              ...
              child: Column(
                children: [
                        ...
                        children: [
                          ...
                          Material(
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text("LOGIN", style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'PTSerif-BoldItalic', fontWeight: FontWeight.bold),)),
                            ),
                          ),
                        ],
                      ),
                  ...
                  GestureDetector(
                    ...
                    child: Text("Don't sign an account? Sign up", style: AppWidget.semiBoolTextFeildStyle(),))
                ],
              ),
            ),
          ],
